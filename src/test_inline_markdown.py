...
from inline_markdow import (
    split_nodes_delimeter, extract_markdown_images, extract_markdown_links, split_nodes_image, split_nodes_link, text_to_textnodes,
)
...
class TestInLineMarkdown(unittest.TestCase):
    ...
    # Test for convert a raw string of markdown-flavored text into a list of TextNode objects
    def test_all_nodes_text(self):
    ...
    def test_only_plain_text(self):
        text = "This is a simple and normal text with no markdown syntax"

        new_nodes = text_to_textnodes(text)
        self.assertListEqual(
            [
                TextNode("This is a simple and normal text with no markdown syntax", TextType.TEXT)
            ],
            new_nodes
        )